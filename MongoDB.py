...
CONNECTION_STRING = "mongodb+srv://byucelyigit:burak123A@vectormongo.mongocluster.cosmos.azure.com/?tls=true&authMechanism=SCRAM-SHA-256&retrywrites=false&maxIdleTimeMS=120000"
DB_NAME = "samplemongodb"
UNSHARDED_COLLECTION_NAME = "vectors"
SAMPLE_FIELD_NAME = "samplefield"
...
def create_database_unsharded_collection(client):
    ...
    container = db.get_container_client(UNSHARDED_COLLECTION_NAME)
